"""
Deterministic Verifier Turing Machine (Certificate-Oblivious Version)
---------------------------------------------------

This module specifies the certificate-oblivious verifier Turing Machine for SAT 
...
No auxiliary parameters or external state are used except the number of variable; 
the machine definition is entirely contained in this module.
...
_TRANSITIONS = {
        ...
        ("Backward.F", "!"): ("Skip", "_", +1),
        ("Backward.T", "S"): ("Skip", "_", +1),
        ("Backward.F", "S"): ("Skip", "_",+1),
