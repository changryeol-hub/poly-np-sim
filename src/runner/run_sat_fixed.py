...
not depend on the input size, making it suitable for predefined SAT verification
tasks.

Key features:
- Fixed-state SAT Verifier Turing Machine: the state set is independent of input.
...
- Includes automated tests (`test_machine`) to validate correctness against
  predefined SAT and UNSAT instances.
